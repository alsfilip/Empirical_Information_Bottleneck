...
def main():
    ...
    for w in read_data:
        ...
        i_p_emp,i_f_emp,beta,mi1,hx,hy = eb(Fpast, Ffuture, numbeta=10000, maxbeta=2000,parallel = parallel) #AF: parallel distributes the beta calculations across the number of specified cores
