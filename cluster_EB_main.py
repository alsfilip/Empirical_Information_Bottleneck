...
def main():
    ...
    for w in read_data:
        ...
        i_p_emp,i_f_emp,beta,mi,hx,hy = eb(Fpast, Ffuture, numbeta=100, maxbeta=.99,parallel = parallel) #AF: parallel distributes the beta calculations across the number of specified cores
